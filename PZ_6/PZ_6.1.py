...
# вывести список размера 10, содержащий 10 первых членов данной прогрессии: A, A + D, A + 2*D, A + 3*D, ... .

def progressions() -> list:
    progression = []
...
if __name__ == "__main__":
    ...
    print(f"Прогрессия первых 10 членов: {progressions()}")
